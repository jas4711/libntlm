...
NTLM_STATIC
void ntlm_des_encrypt(DES_KEY * key, char *block)
{
 ...
 */
NTLM_STATIC
void ntlm_des_decrypt(DES_KEY * key, char *block)
{
	register word32 left, right;
	register char *knp;
	word32 work[2];		/* Working data storage */
...
NTLM_STATIC
int ntlm_des_ecb_encrypt(const void *plaintext, int len, DES_KEY * akey, char output[8])
{
        int j;
